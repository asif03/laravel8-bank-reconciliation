            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
              <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                  <h3 class="text-lg font-medium leading-6 text-gray-900">Reconciliation Statements</h3>
                </div>
              </div>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                      <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-6">
                          ...
                          <select id="report_type" name="report_type" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required autofocus>
                            <option value="S">Summary Report</option>
                            <option value="R">Reconcile Report</option>
                            <option value="U">Un-reconcile Report</option>
                          </select>
                        </div>

                        <div class="col-span-6 sm:col-span-3">
                          <label for="cheque_no" class="block text-sm font-medium text-gray-700">From Date.</label>
                          <input type="text" name="from_date" id="datepicker_frm" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required autofocus>
                        </div>

                        <div class="col-span-6 sm:col-span-3">
                          <label for="issue_date" class="block text-sm font-medium text-gray-700">To Date</label>
                          <input type="text" name="to_date" id="datepicker_to" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" required autofocus>
                        </div>
