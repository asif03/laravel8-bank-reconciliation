            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
              <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                  <h3 class="text-lg font-medium leading-6 text-gray-900">A/C Statement</h3>
                </div>
              </div>
                  ...
                  <div class="shadow overflow-hidden sm:rounded-md">
                    <div class="px-4 py-5 bg-white sm:p-6">
                      ...
                      <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                          <label for="trans_date" class="block text-sm font-medium text-gray-700">Trans Date</label>
                          <input type="text" name="trans_date" id="datepicker" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                          ...
                          <input type="text" name="balance" id="balance" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        </div>
                      </div>
                    </div>
